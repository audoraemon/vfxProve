...
| 5 | **Tornado Tempest** | spiral wind rune + suction ring → shader funnel volume (soft spiral streaks glowing along its edges, warm dusty base, swirling cloud cap) forms → pulls enemies in; caught ones spiral up the funnel and get flung out, rocks and planks orbit in front of and behind it → walks the lane leaving scarred swirls → unravels, dropping debris into dust *(drag = direction)* |
| 6 | **Judgement of the Ancients** | golden earth rune → stone hands and sandstone spikes break out, a hunched stone titan of bevelled plates rises with glowing eyes and chest runes → six knuckle slams on enemy clusters → two-hand final slam with golden shockwave and spike ring → titan crumbles plate by plate |
| 7 | **Dragonfire Parade** | dragon sigil and sweep-arc preview → ground ruptures in lava and obsidian → a scaled fire dragon rises (S-curved neck with belly plates and flaming dorsal spikes, horned head with hinged jaw, bat wings with burning edges) → inhales, then sweeps a thick flame jet across the ground → sinks away, leaving scorched earth and flickering flame patches *(drag = breath direction)* |
