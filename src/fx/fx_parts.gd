...
static func prewarm(parent: Node2D, frames := 3) -> void:
	for shader in [SH_RINGS, SH_SHOCK, SH_DOME, SH_BEAM, SH_DECAL, SH_FOG, SH_SING, SH_LIGHT, SH_RAYS, SH_HAZE, SH_REFRACT, SH_BEAM_ADD, SH_MOLTEN, SH_MUSHROOM, SH_FROST, preload("res://shaders/tsunami_wall.gdshader"), preload("res://shaders/flood_water.gdshader"), preload("res://shaders/flame_stream.gdshader"), preload("res://shaders/tornado_funnel.gdshader"), preload("res://shaders/fire_cone.gdshader")]:
